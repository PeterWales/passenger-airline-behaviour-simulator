...
def fuel_price_with_saf(
    ...
    # adjust SAF total cost back to passenger aircraft only, and account for markup
    saf_passenger_cost_USD = (saf_total_cost_USD * PASSENGER_AC_FUEL_PROPORTION) * (1 + SAF_MARKUP)
